...
// PerformTransaction handles standard DEPOSIT and WITHDRAW
func PerformTransaction(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Transaction failed: Insufficient funds or account error"})
		return
	}
...
// GetTransactionHistory returns a list of all transactions
